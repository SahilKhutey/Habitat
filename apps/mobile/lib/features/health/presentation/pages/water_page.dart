...
class _WaterPageState extends State<WaterPage> {
  ...
  void _showChangeGoalDialog() {
    final goalController = TextEditingController(text: '${_controller.summary.targetMilliliters}');

    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        backgroundColor: HabitatTheme.surfacePrimary,
        title: const Text('DAILY HYDRATION GOAL', style: TextStyle(fontFamily: HabitatTheme.fontHeading, fontSize: 16, fontWeight: FontWeight.w800, color: Colors.white)),
        content: TextField(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: const Color(0xFF4CC9F0), width: 3),
                          ),
                          child: const Icon(Icons.water_drop, color: Color(0xFF4CC9F0), size: 48),
                        ),
                  ...
                  WaterQuickAdd(onAddWater: (amount) => _controller.addPreset(amount)),
                      ...
                      return Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(Icons.local_drink_outlined, size: 18, color: Color(0xFF4CC9F0)),
                            ...
                            Row(
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () => _controller.removeEntry(entry.id),
                                ),
                              ],
                            ),
                          ],
