...
class _IronFortressScreenState extends State<IronFortressScreen> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('HONOR COMMITMENT',
                style: TextStyle(
  ...
  void _requestEmergencyBypass() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: HabitatTheme.surfacePrimary,
        title: const Text('⚠️ EMERGENCY OS BYPASS',
            style: TextStyle(
                color: HabitatTheme.crimsonAlert, fontWeight: FontWeight.bold)),
        content: const Text(
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                    content: Text(
                        'Emergency bypass granted for 15m. Logged to ledger.')),
              );
            },
            child: const Text('UNLOCK FOR 15M',
                style: TextStyle(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: HabitatTheme.amberFocus.withOpacity(0.5)),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                    ...
                    children: [
                      const Text('🛡️ DISTRACTION SHIELD',
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 18,
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('STAKE DISCIPLINE BOND',
                      style: TextStyle(
                          color: HabitatTheme.amberFocus,
                          fontWeight: FontWeight.bold,
                          fontSize: 12,
                      ...
                      return Expanded(
                        child: Container(
                          ...
                          child: OutlinedButton(
                            ...
                            onPressed: () =>
                                setState(() => _selectedBondXp = amount),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('STAKE $_selectedBondXp XP BOND',
                          style: const TextStyle(
            ...
            // 3. Blocked Apps List
            const Text('QUARANTINED APPS (5 BLOCKED)',
                style: TextStyle(
                    color: HabitatTheme.textSecondary,
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                ...
                child: Row(
                  children: [
                    const Icon(Icons.block,
                        color: HabitatTheme.crimsonAlert, size: 20),
            ...
            Center(
              child: TextButton.icon(
                icon: const Icon(Icons.warning_amber,
                    color: HabitatTheme.crimsonAlert, size: 18),
                label: const Text('REQUEST AUDITED EMERGENCY BYPASS',
                    style: TextStyle(
