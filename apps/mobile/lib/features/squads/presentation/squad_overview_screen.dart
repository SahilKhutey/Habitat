  ...
  void _nudgeMember(String name) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Text(
            '⚡ Wakeup Nudge dispatched to $name! Collective streak alert fired.'),
      ),
    );
    setState(() {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                    content: Text('Squad invite code copied: SPARTA26')),
              );
            },
          ),
        ],
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const Text('CODE: SPARTA26',
                            style: TextStyle(
            ...
            const Text("TODAY'S WARRIOR ROSTER (3/4 COMPLETED)",
                style: TextStyle(
                    color: HabitatTheme.textSecondary,
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                ...
                child: Row(
                  children: [
                    Icon(
                      isDone
                          ? Icons.check_circle
                          : (isSiren ? Icons.alarm_on : Icons.schedule),
                      color: isDone
            ...
            // 3. Live Squad Feed
            const Text('SQUAD DISCIPLINE FEED',
                style: TextStyle(
                    color: HabitatTheme.textSecondary,
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
