  ...
  List<PermissionItemModel> getPermissionsDiagnostic() {
    return const [
      PermissionItemModel(
        ...
        usageDescription: 'Delivers scheduled task cues and progress milestones cleanly.',
      ...
      PermissionItemModel(
        ...
        usageDescription: 'Wakes the device reliably at exact scheduled discipline times.',
        status: PermissionState.granted,
        isRequiredForDiscipline: true,
      ),
      PermissionItemModel(
        ...
        usageDescription: 'Captures and verifies visual mission discipline proofs.',
        status: PermissionState.granted,
        isRequiredForDiscipline: true,
      ),
      PermissionItemModel(
        ...
        usageDescription: 'Used for optional voice reflection and sound verification.',
      ...
      PermissionItemModel(
        ...
        usageDescription: 'Optional context verification for location-based habits.',
        status: PermissionState.notRequested,
        isRequiredForDiscipline: false,
      ),
    ];
